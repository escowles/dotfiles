...
# oblique strategies
#
# data from https://github.com/joelparkerhenderson/oblique-strategies/
# originally created by Brian Eno and Peter Schmidt
# see https://en.wikipedia.org/wiki/Oblique_Strategies

N=211 # number of lines of content at the end of this file
IDX=$(( ($RANDOM * 211 / 32768) + 1 ))
tail -$IDX $0 | head -1
exit 0
